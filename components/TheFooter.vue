<template>
  <div
    class="bg-gradient-to-r from-dark to-mediumDark text-white font-unbounded"
  >
    <div
      id="footer"
      class="grid grid-cols-3 place-items-center max-w-xs mx-auto py-12 lg:pb-32 lg:pt-20"
    >
